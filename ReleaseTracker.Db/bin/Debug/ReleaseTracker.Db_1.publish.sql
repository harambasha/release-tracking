...
GO
ALTER TABLE [dbo].[Features] DROP CONSTRAINT [FK__Features__UserId__164452B1];


GO
PRINT N'Altering [dbo].[Features]...';


GO
ALTER TABLE [dbo].[Features] ALTER COLUMN [UserId] BIGINT NOT NULL;


GO
ALTER TABLE [dbo].[Features]
    ADD [ReleaseId] BIGINT NOT NULL;
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Features'), OBJECT_ID(N'dbo.Releases'))
               AND [type] IN (N'F', N'C')
