...
GO
ALTER TABLE [dbo].[Features] DROP CONSTRAINT [FK__Features__UserId__49C3F6B7];
...
GO
ALTER TABLE [dbo].[Features] DROP COLUMN [UserId];


GO
ALTER TABLE [dbo].[Features] ALTER COLUMN [Approved] BIT NOT NULL;
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Users_Roles'))
               AND [type] IN (N'F', N'C')
